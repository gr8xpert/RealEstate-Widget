/**
 * RealtySoft Widget v2 - Individual Share Button Components
...
class RSShareButton extends RSBaseComponent {
    ...
    trackShare() {
        if (this.propertyId) {
            RealtySoftAnalytics.trackShare(this.platform, this.propertyId);
        }
    }
...
class RSShareWhatsApp extends RSShareButton {
    constructor(element, options) {
        super(element, { ...options, platform: 'whatsapp' });
    }
...
class RSShareFacebook extends RSShareButton {
    constructor(element, options) {
        super(element, { ...options, platform: 'facebook' });
    }
...
class RSShareTwitter extends RSShareButton {
    constructor(element, options) {
        super(element, { ...options, platform: 'twitter' });
    }
...
class RSShareLinkedIn extends RSShareButton {
    constructor(element, options) {
        super(element, { ...options, platform: 'linkedin' });
    }
...
class RSShareEmail extends RSShareButton {
    constructor(element, options) {
        super(element, { ...options, platform: 'email' });
    }
...
class RSShareCopy extends RSShareButton {
    constructor(element, options) {
        super(element, { ...options, platform: 'copy' });
    }
...
RealtySoft.registerComponent('rs_share_whatsapp', RSShareWhatsApp);
RealtySoft.registerComponent('rs_share_facebook', RSShareFacebook);
RealtySoft.registerComponent('rs_share_twitter', RSShareTwitter);
RealtySoft.registerComponent('rs_share_linkedin', RSShareLinkedIn);
RealtySoft.registerComponent('rs_share_email', RSShareEmail);
RealtySoft.registerComponent('rs_share_copy', RSShareCopy);
