...
const RealtySoftLabels: RealtySoftLabelsModule = (function () {
  ...
  const languageDefaults: Record<string, Record<string, string>> = {
    es_ES: {
      ...
      detail_per_week: '/semana',
      detail_per_night: '/noche',
      detail_per_year: '/año',
    ...
    pl_PL: {
      ...
      detail_per_week: '/tydzień',
      detail_per_night: '/noc',
      detail_per_year: '/rok',
    ...
    it_IT: {
      ...
      search_location_placeholder: 'Cerca località...',
      search_sublocation: 'Zona',
      search_listing_type: 'Stato',
      search_listing_type_all: 'Stato',
      search_sale: 'Vendita',
      search_rent: 'Affitto',
      listing_type_sale: 'Vendita',
      listing_type_new: 'Nuove Costruzioni',
      listing_type_long_rental: 'Affitto lungo termine',
      listing_type_short_rental: 'Affitto vacanze',
      search_property_type: 'Tipo di proprietà',
      search_property_type_placeholder: 'Qualsiasi tipo',
      search_bedrooms: 'Camere',
      search_bedrooms_any: 'Camere min.',
      search_bedrooms_select: 'Seleziona camere',
      search_bedrooms_input: 'es., 3',
      search_bathrooms: 'Bagni',
      search_bathrooms_any: 'Bagni min.',
      search_bathrooms_select: 'Seleziona bagni',
      search_bathrooms_input: 'es., 2',
      search_price: 'Prezzo',
      search_price_min: 'Prezzo min.',
      search_price_max: 'Prezzo max.',
      search_price_select_min: 'Seleziona prezzo min.',
      search_price_select_max: 'Seleziona prezzo max.',
      search_price_input_min: 'Min (es., 200000)',
      search_price_input_max: 'Max (es., 500000)',
      search_built_area: 'Superficie costruita',
      search_plot_size: 'Terreno',
      search_features: 'Caratteristiche',
      search_features_placeholder: 'Seleziona caratteristiche',
      search_features_filter: 'Cerca caratteristiche...',
      search_reference: 'Riferimento',
      search_button: 'Cerca',
      ...
      // Results
      results_count: '{count} proprietà trovate',
      results_count_one: '1 proprietà trovata',
      results_count_zero: 'Nessuna proprietà trovata',
      results_sort: 'Ordina per',
      results_view_grid: 'Griglia',
      results_view_list: 'Lista',
      results_loading: 'Caricamento...',
      ...
      card_built: 'm²',
      card_plot: 'm²',
      card_view: 'Vedi dettagli',
      card_ref: 'Rif:',

      // Detail
      detail_description: 'Descrizione',
      detail_features: 'Caratteristiche',
      detail_location: 'Posizione',
      detail_sublocation: 'Zona',
      detail_contact: 'Contatta agente',
      detail_share: 'Condividi',
      detail_back: 'Torna ai risultati',
      detail_back_to_search: 'Torna alla ricerca',
      detail_related: 'Proprietà simili',
      detail_year_built: 'Anno di costruzione',
      detail_property_type: 'Tipo di proprietà',
      detail_status: 'Stato',
      detail_reference: 'Riferimento',
      detail_unique_ref: 'Riferimento unico',
      detail_postal_code: 'Codice postale',
      detail_floor: 'Piano',
      detail_orientation: 'Orientamento',
      detail_condition: 'Condizione',
      detail_furnished: 'Arredato',
      detail_views: 'Vista',
      detail_parking: 'Parcheggio',
      detail_built_area: 'Superficie costruita',
      detail_plot_size: 'Terreno',
      detail_usable_area: 'Superficie utile',
      detail_terrace: 'Terrazza',
      detail_solarium: 'Solarium',
      detail_garden: 'Giardino',
      detail_sizes: 'Dimensioni proprietà',
      detail_property_info: 'Informazioni proprietà',
      detail_taxes_fees: 'Tasse e spese',
      detail_community_fees: 'Spese condominiali',
      detail_ibi_tax: 'IBI',
      detail_basura_tax: 'Tassa rifiuti',
      detail_per_month: '/mese',
      detail_per_week: '/settimana',
      detail_per_night: '/notte',
      detail_per_year: '/anno',
      detail_energy_certificate: 'Certificato energetico',
      detail_energy_rating: 'Classe energetica',
      detail_co2_rating: 'Classe CO2',
      detail_additional_resources: 'Risorse aggiuntive',
      detail_video_tour: 'Video tour',
      detail_virtual_tour: 'Tour virtuale',
      detail_download_pdf: 'Scarica PDF',
      detail_floor_plans: 'Planimetrie',
      ...
      // Mortgage Calculator
      mortgage_calculator: 'Calcolatore Mutuo',
      mortgage_property_price: 'Prezzo Proprietà',
      mortgage_down_payment: 'Acconto',
      mortgage_interest_rate: 'Tasso di Interesse',
      mortgage_loan_term: 'Durata Mutuo',
      mortgage_calculate: 'Calcola',
      mortgage_results: 'Rata Mensile',
      mortgage_loan_amount: 'Importo Mutuo',
      mortgage_total_interest: 'Totale Interessi',
      mortgage_total_payment: 'Totale da Pagare',
      mortgage_disclaimer: 'Questa è solo una stima. I pagamenti effettivi possono variare in base a tasse, assicurazioni e altri fattori.',
      years: 'anni',
      month: 'mese',
      ...
      wishlist_title: 'I miei preferiti',
      wishlist_shared_title: 'Preferiti condivisi',
      wishlist_empty: 'I tuoi preferiti sono vuoti',
      wishlist_empty_desc: 'Aggiungi proprietà cliccando sull\'icona del cuore',
      wishlist_share: 'Condividi',
      wishlist_email: 'Email',
      wishlist_pdf: 'Scarica PDF',
      wishlist_clear: 'Cancella tutto',
      wishlist_back: 'Torna ai risultati',
      wishlist_browse: 'Sfoglia proprietà',
      wishlist_add_note: 'Aggiungi nota',
      wishlist_compare: 'Confronta',
      wishlist_confirm_remove: 'Rimuovere questa proprietà dai preferiti?',
      wishlist_confirm_clear: 'Sei sicuro di voler cancellare tutti i preferiti?',
      wishlist_removed: 'Rimosso dai preferiti',
      wishlist_cleared: 'Preferiti cancellati',
      wishlist_no_share: 'Nessuna proprietà da condividere',
      wishlist_loading_shared: 'Caricamento proprietà condivise...',
      wishlist_shared_empty: 'Nessuna proprietà trovata nei preferiti condivisi',
      wishlist_shared_desc: 'Questa è una visualizzazione di sola lettura delle proprietà salvate',
      wishlist_error: 'Errore nel caricamento dei preferiti',
      wishlist_no_properties: 'Nessuna proprietà salvata',
      wishlist_share_title: 'Condividi i tuoi preferiti',
      wishlist_share_desc: 'Condividi questo link con chiunque per mostrare le tue proprietà salvate:',
      wishlist_email_title: 'Invia preferiti via email',
      wishlist_email_to: 'Invia a:',
      wishlist_email_from: 'La tua email (opzionale):',
      wishlist_email_message: 'Messaggio personale (opzionale):',
      wishlist_email_placeholder: 'Aggiungi una nota personale...',
      wishlist_email_send: 'Invia email',
      wishlist_email_sent: 'Email inviata con successo!',
      wishlist_email_error: 'Errore nell\'invio dell\'email',
      wishlist_note_title: 'Aggiungi nota alla proprietà',
      wishlist_note_label: 'La tua nota:',
      wishlist_note_placeholder: 'Aggiungi i tuoi pensieri, domande o promemoria...',
      wishlist_compare_title: 'Confronta proprietà',
      wishlist_compare_clear: 'Cancella selezione',

      // Sort options for wishlist
      sort_wishlist_recent: 'Aggiunti di recente',
      sort_wishlist_oldest: 'Prima i più vecchi',
      sort_wishlist_name: 'Nome: A-Z',
      ...
      compare: 'Confronta',
      compare_max: 'Massimo',
      compare_min: 'Seleziona almeno 2 proprietà da confrontare',
      compare_confirm_clear: 'Cancellare tutte le proprietà selezionate?',
      added: 'Aggiunto',
      note: 'Nota',
      note_saved: 'Nota salvata!',
      note_deleted: 'Nota eliminata',
      confirm_delete_note: 'Eliminare questa nota?',
      copy: 'Copia',
      ...
      // Inquiry form
      inquiry_name: 'Il tuo nome',
      inquiry_first_name: 'Nome',
      inquiry_last_name: 'Cognome',
      inquiry_email: 'La tua email',
      inquiry_phone: 'Il tuo telefono',
      inquiry_message: 'Messaggio',
      inquiry_submit: 'Invia richiesta',
      inquiry_sending: 'Invio in corso...',
      inquiry_success: 'Grazie! La tua richiesta è stata inviata.',
      inquiry_error: 'Spiacenti, si è verificato un errore. Riprova.',
      inquiry_privacy: 'Accetto la privacy policy',
      inquiry_privacy_accept: 'Accetto la',
      inquiry_privacy_policy: 'privacy policy',
      inquiry_country: 'Paese',
      ...
      pagination_page: 'Pagina',
      pagination_of: 'di',
      pagination_load_more: 'Carica altro',
      ...
      general_selected: 'Selezionato',
      general_clear: 'Cancella',

      // Map
      map_precision_exact: 'Posizione esatta',
      map_precision_zipcode: 'Zona codice postale',
      map_precision_area: 'Area',
      ...
      map_geocoding: 'Localizzazione proprietà...',
      map_by_zipcode: 'per codice postale',
      map_no_location: 'senza posizione',
      map_approximate_location: 'Posizione approssimativa',
